...
export class AwsCliCompatible {
  ...
  public static async credentialChainBuilder(
    ...
    return shouldPrioritizeEnv() ? createCredentialChain(fromEnv(), nodeProviderChain) : nodeProviderChain;
  }
...
function shouldPrioritizeEnv() {
  process.env.AWS_ACCESS_KEY_ID = process.env.AWS_ACCESS_KEY_ID || process.env.AMAZON_ACCESS_KEY_ID;
  ...
  console.warn('These are the results for the env check:');
  console.warn(!!process.env.AWS_ACCESS_KEY_ID);
  console.warn(!!process.env.AWS_SECRET_ACCESS_KEY);
  console.warn(process.env.AWS_ACCESS_KEY_ID);
  console.warn(process.env.AWS_SECRET_ACCESS_KEY);
  console.warn(typeof process.env.AWS_ACCESS_KEY_ID);
  console.warn(typeof process.env.AWS_SECRET_ACCESS_KEY);
  console.warn(process.env.AWS_ACCESS_KEY_ID && process.env.AWS_SECRET_ACCESS_KEY);
  console.warn(process.env.AWS_ACCESS_KEY_ID !== undefined && process.env.AWS_SECRET_ACCESS_KEY !== undefined);
